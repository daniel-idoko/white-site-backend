		...
		if err != nil {
			...
			if err != nil {
				...
				if err != nil {
					...
					sendPaypalMail(payerEmail, paymentMethod, paymentID, puppyID, price, filePath, w)
				}
...
func sendPaypalMail(payerEmail, paymentMethod, paymentID, puppyID, price, filePath string, w http.ResponseWriter) {
